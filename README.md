...
- `data/`: Contains the main image data for the project.
  ...
  - `ImageNet-1K`: ImageNet (ILSVRC) 2012, the most commonly used subset of ImageNet. The `val` folder contains the validation set, which can be used for quantitative evaluation of explanation methods.
